...
# Non-case-sensitive autocomplete sugestions
bind 'set completion-ignore-case on' 

# For history search, like on Oh-My-Zsh
...
alias pretty="lg1 = log --graph --abbrev-commit --decorate --format=format:'%C(bold blue)%h%C(reset) - %C(bold green)(%ar)%C(reset) %C(white)%s%C(reset) %C(dim white)- %an%C(reset)%C(bold yellow)%d%C(reset)' --all
"
